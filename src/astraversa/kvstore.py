...
class KVStore:
    ...
    def __getattr__(self, key):
        ...
        schema = type(self).__dict__.get("_schema")
        defaults = type(self).__dict__.get("_defaults")
    ...
    def __setattr__(self, key, value):
        ...
        self._backend.write(key, self._encode(value, typ))  # never hits object.__dict__ at all
